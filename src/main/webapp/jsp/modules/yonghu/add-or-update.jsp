...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>角色</label>
										<select id="jiaoseSelect" name="jiaose" class="form-control">
												<option value=""></option>
												<option class="jiaoseOption" value="学生">
													学生
												</option>
												<option class="jiaoseOption" value="教师">
													教师
												</option>
										</select>	
									</div>	
	...
	<script>
		...
		function dataBind(){
			...
			var jiaoseOptions = document.getElementsByClassName("jiaoseOption");
			for(var jiaoseCount = 0; jiaoseCount < jiaoseOptions.length;jiaoseCount++){
				if(jiaoseOptions[jiaoseCount].getAttribute('value') == ruleForm.jiaose){
					jiaoseOptions[jiaoseCount].setAttribute('selected','selected');
				}
			}
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					var jiaoseOptions = document.getElementsByClassName("jiaoseOption");
						for(var jiaoseCount = 0; jiaoseCount < jiaoseOptions.length;jiaoseCount++){
							if(jiaoseOptions[jiaoseCount].getAttribute('value') == res.data.jiaose){
								jiaoseOptions[jiaoseCount].setAttribute('selected','selected');
							}
						}
					}
