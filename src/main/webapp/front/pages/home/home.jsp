...
<body>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">食堂菜单推荐</span>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in shitangcaidanRecommend" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../shitangcaidan/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-fault ng-container">
                      ...
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../shitangcaidan/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">食堂菜单展示</span>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in shitangcaidanList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../shitangcaidan/detail.jsp?id='+item.id)">
                        <img :src="item.tupian?item.tupian.split(',')[0]:''" />
  ...
  <script type="text/javascript">
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      // 获取推荐信息
      http.request(`shitangcaidan/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.shitangcaidanRecommend = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
              
      http.request(`shitangcaidan/list`, 'get', {
        page: 1,
        limit: 10
      }, function(res) {
        vue.shitangcaidanList = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
